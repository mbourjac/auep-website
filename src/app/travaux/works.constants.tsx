  ...
  },
  {
    ...
    description: (
      <>
        ...
        objectifs de saisir les controverses de la ville néolibérale en revenant
        sur les concepts et théories qui lui sont associés, sur les enjeux de
        justice sociale et spatiale qu’elles soulèvent, ainsi que sur les
        luttes, résistances et éventuelles alternatives au capitalisme urbain.
        Plus précisément, il s’agit de&nbsp;: comprendre les enjeux de la
        mondialisation néolibérale et leurs effets sur les villes&nbsp;;
    ...
    dissertations: [
      {
        ...
        description: (
          <>
            ...
            de l’Estacade à Grenoble illustre cette temporalité mouvante. Espace
            de stationnement en semaine, il devient chaque matin un lieu de vie
            animé. Ce mémoire s’attache à comprendre le lien affectif qui unit
            les usagers à cet espace éphémère.
            <br />
      ...
      },
      {
        ...
        title: (
          <>
            Frontières de l’espace public. Perceptions et expériences vécues des
            usagers de la place Vaucanson et du square Docteur Martin
          </>
        ),
        description: (
          <>
            ...
            insuffisamment exploré. Ce mémoire s’intéresse à la place Vaucanson
            et au square Docteur Martin à Grenoble, deux espaces contigus mais
            aux caractéristiques distinctes, pour comprendre comment ces
            frontières sont perçues et vécues par leurs usagers.
            ...
            impressions de protection et d’exposition, sentiment de sécurité et
            de vulnérabilité. Elle souligne également le rôle des aménagements
            urbains comme marqueurs tangibles de frontières à la fois spatiales
            et sociales.
          </>
        ),
      ...
      },
      {
        ...
        title: (
          <>
            ...
            Hugo &nbsp;: Lumière urbaine et usages/pratiques de l’espace public
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            Le balcon comme expression du domestique dans la ville. Perceptions
            et influences réciproques entre espace privé et espace public
          </>
        ),
        description: (
          <>
            ...
            l’autre, à travers ses usages, pratiques, formes d’appropriation et
            ambiances qu’il produit lui-même. À travers une double lecture,
            ...
            de l’espace urbain à travers sa position en hauteur tout en agissant
            comme filtre sensoriel appropriable qui permet de réguler la
            perméabilité entre intérieur et extérieur. Enfin, l’asymétrie de son
            expérience révèle comment les contextes sociaux et culturels propres
            à chaque site régissent la manière dont habitants et passants
            interagissent et composent avec la présence de l’autre.
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            école d’architecture, notamment à l’ENSAG dans la période de 2020 à
            2025.
            <br />
            Ce travail s’interroge sur le parcours, la place, le rôle et
            l’importance des personnes formées aux métiers de l’urbain et de son
            aménagement, s’étant engagées dans un mandat local, celui de maire.
            En effet, le maire est un maillon important, tant symboliquement que
            par son pouvoir décisionnaire au sein de sa commune, étant un lien
            essentiel entre l’état et ses concitoyen.ne.s. Ce mémoire interroge
            cinq maires ayant été formés à la conception, sur leurs rapports à
            la politique, leurs études ainsi que les liens et intérêts qu’ils
            trouvent entre ces deux aspects d’engagement et de leur vie.
          </>
        ),
  ...
  },
  {
    ...
    dissertations: [
      ...
      },
      {
        ...
        title: (
          <>
            Accès à la ressource en eau dans les alpages des massifs du Vercors
            et de Belledonne. Étude comparative de l’adaptation des pratiques
            pastorales face au dérèglement climatique
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            Accès à l’eau et l’hygiène en bidonville. L’eau comme instrument de
            gouvernement des marges urbaines. Le cas de Grenoble
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        description: (
          <>
            ...
            oreilles entendraient. Cette intraductibilité naturelle prend place
            dans un silence plus grand, celui de la crise environnementale. Or,
            ce n’est pas tant l’absence d’organe de la voix ou le silence de
            l’Isère qui est problématique mais l’espace qui se dégage de ce
            silence.
            <br />
            D’un point de vue légal, parce qu’il n’existe pas de personne morale
            de la rivière il y a une sorte d’espace blanc qui est meublé par les
            autres voix que le droit permet de faire exister. Ce sont les sujets
            de droit, qu’ils soient entreprises ou humains.
            <br />
            Cet espace blanc ou ce silence peut être interprété comme une forme
            d’assentiment tacite ou d’incapacité par ces derniers. Il s’agit
            alors de s’intéresser au projet de parlement de la rivière Isère
            comme manière de dépasser la division objet de droit – sujet de
            droit. Plus largement, de dépasser une division entre deux
      ...
      },
      {
        ...
        title: (
          <>
            Récits de l’été 2023 des enfants de la Villeneuve. Des barrières aux
            opportunités&nbsp;: quelle accessibilité aux lieux de
            rafraîchissement&nbsp;?
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            La fontaine, un objet de l’espace public. Étude de la relation entre
            les habitants de Grenoble et les fontaines
          </>
        ),
        description: null,
    ...
    dissertations: [
      {
        ...
        title: (
          <>
            ...
            urbain&nbsp;: ZAC Lustucru, Bouchayer-Viallet et De Bonne à Grenoble
          </>
        ),
        description: null,
        supervisedBy: 'Adriana Diaconu',
      ...
      },
      {
        ...
        title: (
          <>
            Des trajectoires résidentielles aux effets de quartier. Le choix de
            vivre place Saint-Bruno à travers le récit de ses habitants
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            ...
            innovant «&nbsp;Gren’ de projets&nbsp;». La régénération de l’ancien
            couvent des Minimes
          </>
        ),
        description: (
          <>
            ...
            entrepreneurs grenoblois ont été sélectionnés pour prendre en charge
            un ancien édifice religieux dans le centre-ville de Grenoble via un
            bail emphytéotique. Leur projet prévoit diverses activités&nbsp;:
            coworking, hostel, restauration, etc. Le bâtiment ayant été occupé
            par différentes structures associatives, des délogements et
            relogements se sont imposés pour accueillir ce nouveau projet. Ce
            mémoire examine donc les justifications, les stratégies et les
            moyens d’action déployés par les différents acteurs du projet&nbsp;;
            les processus d’inclusion et d’exclusion socio-spatiale de cette
            régénération&nbsp;; la manière dont une collectivité gère et délègue
            son patrimoine foncier en substituant des acteurs par d’autres,
            porteurs de la promesse d’une animation renouvelée du lieu et du
            quartier.
          </>
        ),
        supervisedBy: 'Federica Gatta',
      },
      {
        ...
        title: (
          <>
            Intégrer les enjeux climatiques dans le processus de conception des
            espaces publics dans le bâti dense
          </>
        ),
        description: null,
        supervisedBy: 'Théa Manola',
      },
      {
        ...
        title: (
          <>
            Impulsion locale d’une transition écologique nationale. Le cas de la
            mise en œuvre de la ZCR/ ZFE à Grenoble en 2016
          </>
        ),
        description: null,
        supervisedBy: 'Marine Bourgeois',
      },
      {
        ...
        title: (
          <>
            Fonctions et usages des cours de récréation. Étude comparative d’une
            école primaire publique et d’une école privée Montessori
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            On touche avec les yeux. Comprendre la financiarisation des marchés
            immobiliers à travers l’investissement dans l’immobilier de luxe
          </>
        ),
        description: (
          <>
            À l’aire de la financiarisation du capitalisme urbain, quelle est la
            nouvelle articulation des marchés immobiliers et financiers&nbsp;?
            Dans ce mémoire, nous appréhendons cette question au regard d’un
            marché peu étudié par la recherche&nbsp;: celui de l’immobilier de
            luxe. Ce marché qui à l’échelle internationale s’est développé en
            parallèle et sur la même temporalité que la globalisation est une
            porte d’entrée de la financiarisation aux marchés immobiliers. Après
            avoir défini ce qu’est le luxe en matière d’immobilier, nous
            étudions l’évolution de ce marché à Paris, une ville mondiale, très
            intégrée aux circuits de la finance, pour y démontrer la
            financiarisation de l’immobilier de luxe. Ensuite, nous posons la
            question des représentations des différents acteurs de ce marché sur
            ses investisseurs particuliers qui le dominent.
          </>
        ),
  ...
  },
  {
    ...
    dissertations: [
      ...
      },
      {
        ...
        title: (
          <>
            L’urbaniste au défi de la concertation habitante. Comment la posture
            de l’urbaniste oriente t-elle l’évolution du projet de réécriture du
            Plan Local d’Urbanisme d’une petite commune périurbaine de
            Grenoble&nbsp;?
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            Perceptions, retranscriptions et représentations des espaces publics
            par les enfants
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            Qui a le droit à l’espace public&nbsp;? Étude des procédés spatiaux
            de la racialisation à Grenoble
          </>
        ),
        description: null,
      ...
      },
      {
        ...
        title: (
          <>
            ...
            d’architecture. Aux fondements des représentations à l’ENSA Grenoble
          </>
        ),
        description: (
          <>
            ...
            par des modèles, qui incarnent la précarité économique de l’exercice
            professionnel et dont les récits sont fortement véhiculés par les
            media sociaux. L’inquiétude étudiante est nourrie par une faible
            estime de leurs savoirs, jugés trop lacunaires, en particulier pour
            les femmes, dont les expériences sexistes freinent les parcours.
            <br />
            Se distinguant de l’idée de professionnalisation, le concept de
            développement professionnel met en avant l’activité réalisée par le
            sujet, devenant support d’apprentissage et revendiquée comme
            constitutive de l’identité professionnelle. Ce décalage de focale
            permet de révéler la richesse de la formation et des apprentissages
            choisis par les étudiant⸱es. Il permet aussi de traduire
            l’enthousiasme des étudiant⸱es à s’engager dans des pratiques
            professionnelles transversales, répondant aux crises des sociétés et
            pouvant (re)valoriser les architectes.
          </>
        ),
