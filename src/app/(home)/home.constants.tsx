  ...
  },
  {
    ...
    description: (
      <>
        ...
        de Bologne. Il est membre permanent du LHAC, ENSA Nancy, et membre
        associé de l’OCS/AUSser, ENSA Paris-Est. Architecte praticien au sein de
  ...
  },
  {
    ...
    description: (
      <>
        ...
        la géographie des territoires de l’eau. Il s’agit d’appréhender à la
        fois les mécanismes sociaux d’appropriation et de contrôle de cette
        ressource mais aussi leurs conséquences pour l’organisation et le
        fonctionnement des territoires. Il a ainsi particulièrement travaillé en
        France sur la territorialisation des politiques de l’eau et plus
        particulièrement les approches par bassin et leurs liens avec les
        processus d’aménagement du territoire et de décentralisation.
        Aujourd’hui, ses travaux portent sur la gouvernance littorale à partir
        de nouveaux objets géographiques comme les complexes lagunaires ou
  ...
  },
  {
    ...
    description: (
      <>
        ...
        les outils de conception et perturbe l’appréhension des territoires et
        des processus de projet. Son studio Omanoeuvres (fondé en 2018) utilise
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        Patrick Henry est architecte et urbaniste, professeur à l&apos;École
        nationale supérieure d&apos;architecture de Paris-Belleville, membre du
        conseil scientifique de l&apos;IPRAUS/AUSser. Il est le responsable de
        la formation post-master Architecture des territoires, mention projet et
        recherche. Ses activités académiques croisent les activités de sa
  ...
  },
  {
    ...
    description: (
      <>
        ...
        campagne d’entretiens et d’une observation participante. Il vise à mieux
        comprendre le peuplement des centres-villes, en tant qu’état, en tant
        que représentation et en tant que mode d’action publique. Nos résultats
  ...
  },
  {
    ...
    description: (
      <>
        ...
        Son travail doctoral porte sur la rente dans le secteur de la location
        de logements à Bruxelles. Il étudie la structure de la propriété des
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        Maryame Amarouche est docteure en géographie et aménagement et maîtresse
        de conférences en aménagement du territoire et urbanisme à
        l&apos;Université Jean Moulin Lyon 3. Ses recherches portent sur
        l&apos;aménagement et les politiques urbaines dans les périphéries
        métropolitaines (espaces périurbains, ruraux, villes petites et
        moyennes). À partir d&apos;une approche comparative entre Nords et Suds
        et pluridisciplinaire associant la géographie, l&apos;urbanisme et les
        sciences politiques, elle interroge la fabrique de l&apos;urbain sous
  ...
  },
  {
    ...
    description: (
      <>
        ...
        documentaires long-métrages. Depuis 1996, Michel Favre développe une
        activité artistique commune avec Fabiana de Barros sous le nom de
        FABMIC. Ensemble, ils réalisent des installations vidéo, des
        performances multimédias et des séries photographiques. Il a collaboré
        occasionnellement pendant plus de dix ans avec la Télévision Suisse
  ...
  },
  {
    ...
    description: (
      <>
        ...
        les pratiques en faveur des métropoles.
        <br />
        Nadia Arab est professeure à l’Ecole d’Urbanisme de Paris(UPEC) et
        directrice. Docteure de l’Ecole des Ponts, elle a soutenu une thèse sur
        les processus d’élaboration des projets d’urbanisme puis une
        Habilitation à Diriger des Recherches autour d’une lecture critique de
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        Maître de conférences HDR en histoire médiévale à l’université de Paris
        1, Hélène Noizet travaille sur la morphologie urbaine. Elle analyse la
        formation du tissu urbain comme un processus qui remet sans cesse en jeu
        les espaces hérités, en interaction permanente avec les projets et les
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        Laurent Matthey enseigne à l’Université de Genève. Ses recherches
  ...
  },
  {
    ...
    description: (
      <>
        ...
        Villette, directrice de l’équipe AHTTEP de l’UMR AUSser. Ses travaux de
        recherche portent essentiellement sur la ville et le territoire des
        Etats-Unis. Ils ont pu être réalisés grâce, notamment, à des bourses de
        recherche allouées par le Centre Canadien d’architecture (Montréal), le
  ...
  },
  {
    ...
    description: (
      <>
        ...
        d’Architecture Paris Belleville, directeur de l’équipe IPRAUS de l’UMR
        AUSser. Ses travaux de recherche portent principalement sur les
        phénomènes métropolitains, sur l’histoire des villes et de l’urbanisme
        et la contribution qu’y ont apportée les architectes, notamment en
        France et en Amérique du Nord. Ils ont bénéficié du soutien
        d’institutions comme le Centre canadien d’architecture (Montréal) ou le
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        Nicolas Douay est Professeur des Universités. Diplômé de l’Université de
        Montréal et Aix-Marseille Université, il a séjourné au Centre d’études
        français sur la Chine contemporaine à Hong Kong en 2008 et 2009, puis de
        2015 à 2017. Il a enseigné à l’Université de Montréal, à l’Université de
        Paris, à l’INET-CNFPT et à l’Université Grenoble Alpes. Ses recherches
        font une large place aux approches comparatives et se focalisent sur les
        politiques urbaines, les processus de planification territoriale et les
        usages du numérique dans l’aménagement. Il est actuellement en
  ...
  },
  {
    ...
    description: (
      <>
        ...
        penser.
        <br />
        Laurent Devisme est professeur d’études urbaines à l’Ensa Nantes. Il
        pratique notamment une ethnographie de l’urbanisme en actes. Il a
        notamment publié &quot;La ville décentrée, les figures centrales à
