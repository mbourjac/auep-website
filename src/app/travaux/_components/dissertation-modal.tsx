...
import { Dissertation } from '../works.types';

type DissertationModalProps = Dissertation & {
  year: string;
};
    ...
    <Dialog.Portal>
      ...
      >
        <div className="border-primary flex items-center justify-between border-b-4">
          <p className="px-4 text-2xl font-bold">Mémoire</p>
        ...
        <div className="flex overflow-hidden">
          ...
          >
            <div className="border-primary border-b-4 p-4">
              <Dialog.Title className="font-bold">{student}</Dialog.Title>
              <p className="italic">{year}</p>
            </div>
            <Dialog.Description asChild>
              <div className="flex flex-col gap-4 overflow-y-auto p-4">
                <div>
                  <p className="border-b font-semibold">{title}</p>
